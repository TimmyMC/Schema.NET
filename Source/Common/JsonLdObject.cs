...
{
    /// <summary>
    /// Gets the context used to define the shorthand names that are used throughout a JSON-LD document.
    /// These shorthand names are called terms and help developers to express specific identifiers in a compact
    /// manner.
