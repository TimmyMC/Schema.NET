...
public class Values7Test
{
    ...
    [Fact]
    public void CollectionExpression_Value7Passed_OnlyValue7HasValue()
    {
    ...
    {
        var person = new Person();
        Values<int, string, DayOfWeek, Person, DateTime, bool, TimeSpan> values = [1, "Foo", DayOfWeek.Friday, person, DateTime.MinValue, true, TimeSpan.MinValue];
    ...
    {
        Values<int, string, DayOfWeek, Person, DateTime, bool, TimeSpan> values =
        [
            string.Empty,
            null!,
            "\u2028 \u2029 \u0009 \u000A \u000B \u000C \u000D \u0085"
