...
public class Values7Test
{
    ...
    public void ConstructorScenarios(Values7TestScenario s)
    {
        ...
        Assert.Equal(s.ExpectedHasValue7, values.HasValue7);
        ...
        Assert.Equal(s.ExpectedCountValue7, values.Value7.Count);
