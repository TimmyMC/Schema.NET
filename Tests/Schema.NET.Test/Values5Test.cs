...
public class Values5Test
{
    ...
    public void Equals_MixedTypes_Value1EqualValue2EqualValue3EqualValue4EqualValue5NotEqual_ReturnsFalse() =>
        Assert.False(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Tuesday, new Person(), DateTime.MinValue).Equals(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Tuesday, new Person(), DateTime.MaxValue)));

    [Fact]
    public void Equals_MixedTypes_Value1EqualValue2EqualValue3EqualValue4NotEqualValue5Equal_ReturnsFalse() =>
        Assert.False(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Tuesday, new Person(), DateTime.MinValue).Equals(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Tuesday, new Person { Name = "Schema" }, DateTime.MinValue)));

    [Fact]
    public void Equals_MixedTypes_Value1EqualValue2EqualValue3NotEqualValue4EqualValue5Equal_ReturnsFalse() =>
        Assert.False(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Tuesday, new Person(), DateTime.MinValue).Equals(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Wednesday, new Person(), DateTime.MinValue)));

    [Fact]
    public void Equals_MixedTypes_Value1EqualValue2NotEqualValue3EqualValue4EqualValue5Equal_ReturnsFalse() =>
        Assert.False(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Tuesday, new Person(), DateTime.MinValue).Equals(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Bar", DayOfWeek.Tuesday, new Person(), DateTime.MinValue)));

    [Fact]
    public void Equals_MixedTypes_Value1NotEqualValue2EqualValue3EqualValue4EqualValue5Equal_ReturnsFalse() =>
        Assert.False(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Tuesday, new Person(), DateTime.MinValue).Equals(new Values<int, string, DayOfWeek, Person, DateTime>(1, "Foo", DayOfWeek.Tuesday, new Person(), DateTime.MinValue)));

    [Fact]
    public void Equals_MixedTypes_ThisMissingValue5_ReturnsFalse() =>
        Assert.False(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Tuesday, new Person()).Equals(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Tuesday, new Person(), DateTime.MinValue)));

    [Fact]
    public void Equals_MixedTypes_ThisMissingValue4_ReturnsFalse() =>
        Assert.False(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Tuesday, DateTime.MinValue).Equals(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Tuesday, new Person(), DateTime.MinValue)));

    [Fact]
    public void Equals_MixedTypes_ThisMissingValue3_ReturnsFalse() =>
        Assert.False(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", new Person(), DateTime.MinValue).Equals(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Tuesday, new Person(), DateTime.MinValue)));

    [Fact]
    public void Equals_MixedTypes_ThisMissingValue2_ReturnsFalse() =>
        Assert.False(new Values<int, string, DayOfWeek, Person, DateTime>(0, DayOfWeek.Tuesday, new Person(), DateTime.MinValue).Equals(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Tuesday, new Person(), DateTime.MinValue)));

    [Fact]
    public void Equals_MixedTypes_ThisMissingValue1_ReturnsFalse() =>
        Assert.False(new Values<int, string, DayOfWeek, Person, DateTime>("Foo", DayOfWeek.Tuesday, new Person(), DateTime.MinValue).Equals(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Tuesday, new Person(), DateTime.MinValue)));

    [Fact]
    public void Equals_MixedTypes_OtherMissingValue5_ReturnsFalse() =>
        Assert.False(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Tuesday, new Person(), DateTime.MinValue).Equals(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Tuesday, new Person())));

    [Fact]
    public void Equals_MixedTypes_OtherMissingValue4_ReturnsFalse() =>
        Assert.False(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Tuesday, new Person(), DateTime.MinValue).Equals(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Tuesday, DateTime.MinValue)));

    [Fact]
    public void Equals_MixedTypes_OtherMissingValue3_ReturnsFalse() =>
        Assert.False(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Tuesday, new Person(), DateTime.MinValue).Equals(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", new Person(), DateTime.MinValue)));

    [Fact]
    public void Equals_MixedTypes_OtherMissingValue2_ReturnsFalse() =>
        Assert.False(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Tuesday, new Person(), DateTime.MinValue).Equals(new Values<int, string, DayOfWeek, Person, DateTime>(0, DayOfWeek.Tuesday, new Person(), DateTime.MinValue)));

    [Fact]
    public void Equals_MixedTypes_OtherMissingValue1_ReturnsFalse() =>
        Assert.False(new Values<int, string, DayOfWeek, Person, DateTime>(0, "Foo", DayOfWeek.Tuesday, new Person(), DateTime.MinValue).Equals(new Values<int, string, DayOfWeek, Person, DateTime>("Foo", DayOfWeek.Tuesday, new Person(), DateTime.MinValue)));
